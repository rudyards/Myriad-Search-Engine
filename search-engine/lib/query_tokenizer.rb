...
class QueryTokenizer
  def tokenize(str)
    ...
    until s.eos?
      ...
      elsif s.scan(/(is|not)\s*[:=]\s*(pointed|vanilla|spell|permanent|funny|timeshifted|colorshifted|reserved|multipart|promo|primary|secondary|front|back|commander|digital|reprint|fetchland|shockfetch|dual|fastland|bounceland|gainland|filterland|checkland|manland|scryland|battleland|augment|unique|booster|draft|historic|holofoil|foilonly|nonfoilonly|foil|nonfoil|foilboth|brawler)\b/i)
